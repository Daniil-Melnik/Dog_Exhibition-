...
public class judgeInfo {
    ...
    public void show(Judge judge){
        ...
        Object[] columns = new String[] {"id породы", "Название породы"};
        ...
        table1.getColumn("id породы").setPreferredWidth(30);
        ...
        List<J_B_com> coms =J_B_comDao.getComs();

        for (int i =0; i<coms.size(); i++){
            J_B_com com = coms.get(i);
            if(com.getJudge().getId() == judge.getId()){
                tableModel.insertRow(0, new Object[]{com.getId(), com.getBreed().getTitle()});
            }
        }
        ...
        export.addActionListener(new ActionListener()
			{
				public void actionPerformed (ActionEvent event)
				{
					try 
					{
						...
						fileChooser.setSelectedFile(new File("judge_.pdf"));
						...
						if (result == JFileChooser.APPROVE_OPTION) 
						{
							...
							String para_1 = "Информация о судье: "+judge.getName(); 
