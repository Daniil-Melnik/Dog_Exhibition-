...
public class ownerInfo {
    ...
    public void show(Owner owner){
        ...
        Object[] columns = new String[] {"id собаки", "Кличка", "Порода"};
        ...
        table1.getColumn("id собаки").setPreferredWidth(30);
        ...
        for (int i =0; i<dL.size(); i++){
            Dog dl = dL.get(i);
            if(dl.getOwner().getId()==owner.getId()){
                tableModel.insertRow(0, new Object[]{dl.getId(), dl.getName(), dl.getBreed().getTitle()});
            }
        }
				...
				public void actionPerformed (ActionEvent event)
				{
					try 
					{
						...
						if (result == JFileChooser.APPROVE_OPTION) 
						{
							...
							String para_1 = "Информация о владельце: "+owner.getName(); 
